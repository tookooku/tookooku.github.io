			...
			switch (substr($item, 0, strlen($value[1])))
			{
				...
				case 'CMS': 
                    ...
                    if(isset($cms['information_id'])) {
    					...
    					$this->_menuLink .= '<div  class ="pt_menu_cms pt_menu"><div class="parentMenu" ><a href="'.$cms_link.'"><span>'.$cms['title'].'</span></a></div></div>'.PHP_EOL;
                    }
			}
...
//        $html[] = '</a>';
	...
	public function drawCustomMenuItem($category, $level = 0, $last = false, $item, $lang_id,$setting) {
		...
		if(isset($cate['thumbnail_image']) && $cate['thumbnail_image'] != '') {
             $thumbnail_image =  $this->model_tool_image->resize($cate['thumbnail_image'], 21,19);
